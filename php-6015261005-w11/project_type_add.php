                ...
                <?php
                    if(isset($_GET['submit'])){
                        ...
                        if(mysqli_query($conn,$sql)){
                            echo "เพิ่มสถานะโครงการ $ptt_name เรียยร้อยแล้ว";
                        }else{
                            echo "เพิ่มสถานะโครงการ $ptt_name ผิดพลาด<br>";
                        }
                        mysqli_query($conn,$sql);
                        mysqli_close($conn);
                        echo "เพิ่มคำนำหน้า $ptt_name เรียบร้อยแล้ว<br>";
                        echo '<a href="project_type_list.php">สถานะ</a>';
                    }else{
                ?>
                    <form class="form-horizontal" role="form" name="project_status_add" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <div class="form-group">
                            <label for="ptt_name" class="col-md-2 col-lg-2 control-label">สถานะโครงการ</label>
